...
There is a PSI AC620 and a JET air cleaner hung over the tablesaw. Both of these should be running if the shop is in use. the JET has a remote control panel which has been bypassed in a reversible manner so that it is always in high mode if it's plugged in. The PSI has a pull-chain which should always be turned on.
...
### Ownership
- JET: David Wilson? Zaq?
- PSI: Bought from Spencer?

### Replacement Parts

Replacement filters are available from McMaster-Carr:
- Outer: [2150K23](https://www.mcmaster.com/2150K23)
